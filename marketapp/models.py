...
class PostModel(models.Model):
    id = models.AutoField(primary_key=True)
    user = models.ForeignKey(User, on_delete=models.CASCADE)
    # belonged = models.ForeignKey(User, on_delete=models.CASCADE)
...
class TransactionModel(models.Model):
    ...
    # A is the sender
    sender = models.ForeignKey(User, on_delete=models.CASCADE, related_name="as_sender")
    # B is the receiver
    receiver = models.ForeignKey(User, on_delete=models.CASCADE, related_name="as_receiver")
